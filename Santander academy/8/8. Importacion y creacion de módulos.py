...
import. Luego, se utiliza la función sqrt() del módulo math para calcular la raíz cuadrada de 25.")
...
La funcion math proporciona funciones matematicas como sqrt() (raiz cuadrada),sin() (seno), cos() (coseno), entre otras.")

La funcion random Ofrece funciones para generar números aleatorios, como random() (número aleatorio entre 0 y 1), randint() (número entero aleatorio en un rango), entre otras.")

La funcion Datetime Permite trabajar con fechas y horas, como datetime.now() (fecha y hora actual), datetime.date() (fecha), datetime.time() (hora), entre otras.")
"""
